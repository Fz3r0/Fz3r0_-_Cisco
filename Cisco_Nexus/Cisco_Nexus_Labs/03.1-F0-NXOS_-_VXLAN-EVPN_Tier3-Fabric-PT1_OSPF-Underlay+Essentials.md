...
This lab represents the first phase of a 4-part VXLAN/EVPN deployment. The main goal is to build a solid and scalable topology foundation, with a fully functional **underlay network** using a dynamic IGP (in this case, OSPF).
...
1. Crear un routeo solido entre todos los equipos (BGW, Spines, Leafs), en este caso una red OSPF con peer-links /31 entre los equipos. esto sirve para bl abl abla
