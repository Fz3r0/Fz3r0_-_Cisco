...
Los pasos para habilitar PIM en las interfaces de los RP, es decir, los spines que envian la informacion a todos los suplicantes son basicamente lso mismos, con al diferencia que como este es el RP hay que indicarle que tanto este spines es el rp y se comparte la direcicon con otro spine. esto se hace con el comando `ip pim anycast-rp 10.255.255.255 10.10.10.13` y `ip pim anycast-rp 10.255.255.255 10.10.10.14`. Es decir, solo cambia el paso 4 que sera Indicarle que el es un RP que comparte IP con otro RP, para eso se usan los loopback0 de ambos Spines

1. Habilitar el feature de PIM
2. Habilitarlo en las interfaces fisicas partcipantes con `ip pim sparse-mode`
3. Habilitarlo en la loopback0 con `ip pim sparse-mode`
4. *Indicarle que el es un RP que comparte IP con otro RP, para eso se usan los loopback0 de ambos Spines
...
!# Step 4.  Indicarle que el es un RP que comparte IP con otro RP, para eso se usan los loopback0 de ambos Spines
