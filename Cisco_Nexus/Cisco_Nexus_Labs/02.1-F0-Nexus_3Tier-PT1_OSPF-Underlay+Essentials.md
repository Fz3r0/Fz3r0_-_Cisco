...
!# Deja solo una ruta estática a 0.0.0.0 0.0.0.0 en cada vEdge con distinto valor de distancia administrativa (menor AD = preferencia).
...
!# OSPF Backbone (optional / just for testing)
...
!# Default Route para alcanzar vEdge-1 (para todo lo no conectado directo)
...
! Ruta de retorno al túnel interno vEDGE-to-vEDGE
ip route 100.1.5.0 255.255.255.252 123.4.4.2
