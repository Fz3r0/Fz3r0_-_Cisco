...
ip route 10.200.0.100 255.255.255.255 223.1.1.2
ip route 10.210.0.100 255.255.255.255 223.1.1.2
...
router ospf 1
    ...
    !# enlace hacia NX9-2
    network 2.2.0.0 0.0.0.3 area 0
    !# enlace Edge-to-Edge
    network 5.2.0.0 0.0.0.3 area 0
...
interface Ethernet0/0
   ...
   duplex full
   description ** Link-to-SW-L3-MGMT-2 **
   ip address 4.2.0.1 255.255.255.252
   ip ospf network point-to-point
   ip ospf cost 1
   ip ospf hello-interval 1
   ip ospf dead-interval 4
...
interface Ethernet0/1
   ...
   duplex full
   description ** Link-to-SW-L3-MGMT-1 **
   ip address 3.2.0.1 255.255.255.252
   ip ospf network point-to-point
   ip ospf cost 100
   ip ospf hello-interval 1
   ip ospf dead-interval 4
...
router ospf 1
    ...
    !# enlace hacia NX9-1
    network 3.2.0.0 0.0.0.3 area 0
    !# enlace hacia NX9-2
    network 4.2.0.0 0.0.0.3 area 0
    !# enlace Edge-to-Edge
    network 5.2.0.0 0.0.0.3 area 0
...
ip route 1.0.0.0 255.0.0.0 223.1.1.2
ip route 2.0.0.0 255.0.0.0 223.1.1.2
ip route 3.0.0.0 255.0.0.0 223.1.1.2
ip route 4.0.0.0 255.0.0.0 223.1.1.2
ip route 5.0.0.0 255.0.0.0 223.1.1.2
ip route 6.0.0.0 255.0.0.0 223.1.1.2
...
ip route 1.0.0.0 255.0.0.0 10.100.0.6
