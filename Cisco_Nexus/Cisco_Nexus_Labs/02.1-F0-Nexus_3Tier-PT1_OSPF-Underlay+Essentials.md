...
|# Deja sólo una ruta estática a 0.0.0.0/0 en cada vEdge, con distinto valor de distancia administrativa (AD) (menor = preferencia). Con esto, si en vEDGE-1 falla su enlace a WAN1 (123.1.1.1), automáticamente usará el next-hop 100.1.5.2 (tu enlace “edge-to-edge” hacia vEDGE-2), y luego vEDGE-2 sacará todo por su WAN2.
