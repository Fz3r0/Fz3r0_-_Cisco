...
!#######################################################################################
!#  L3 INTERFACE & SUB-INTERFACE @ LAN (VRFs: management & default) // INSIDE                    #
!#######################################################################################
...
!# ACL que define el tráfico interno a traducir
access-list 10 permit 10.10.0.0 0.0.255.255

!# NAT Overload para todo lo que entre por inside y salga por outside
