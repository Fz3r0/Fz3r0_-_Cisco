...
![image](https://github.com/user-attachments/assets/6334e715-8dfe-4876-bee1-db934fb26188)
...
!#######################################################################################
!#  TRUNK INTERFACES (VRF: management)                                                 #
!#######################################################################################
...
!#######################################################################################
!#  TRUNK INTERFACES (VRF: management + default) ==>> @ WAN                            #
!#######################################################################################

!# INTERFACE :: ETH 1/3 @ SWITCH-L2 (Trunk) :: VRF ALL! (@ WAN)
int ethernet1/3
   description ** Trunk @ WAN (ALL VRFs) **
   no shutdown
   duplex full
      switchport
      switchport trunk encapsulation dot1q
