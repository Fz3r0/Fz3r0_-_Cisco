...
| ------------ | ---------- | ------------- | ---------------- | -------- | ----------------- | ----------------------------- |
| 🌐 **R1**    | `65001`    | Eth0          | `1.0.0.1`        | `/30`    | `255.255.255.252` | WAN link to R2                |
...
| 📡 **R2**    | `65002`    | Eth0          | `1.0.0.2`        | `/30`    | `255.255.255.252` | Link to R1                    |
|              |            | Eth1          | `2.0.0.1`        | `/30`    | `255.255.255.252` | Link to R3                    |
| 📡 **R3**    | `65003`    | Eth1          | `2.0.0.2`        | `/30`    | `255.255.255.252` | Link to R2                    |
|              |            | Eth0          | `3.0.0.1`        | `/30`    | `255.255.255.252` | Link to R4                    |
| 🌐 **R4**    | `65004`    | Eth0          | `3.0.0.2`        | `/30`    | `255.255.255.252` | WAN link to R3                |
