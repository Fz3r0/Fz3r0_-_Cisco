...
!# Step 1 – Create the ACL:
   ...
   !# Block a single host >> (BLOCK SERVER-3)
access-list 15 deny 128.1.1.10 0.0.0.0

   !# Block a /30 subnet  >> (BLOCK SERVER-4 SUBNET 111.0.0.0/30)
access-list 15 deny 111.0.0.0 0.0.0.3
